...
military = {
    ...
    SUPPLY_RANGE = 50,
	POP_MIN_SIZE_FOR_REGIMENT_PROTECTORATE_MULTIPLIER = 1,
	POP_MIN_SIZE_FOR_REGIMENT_COLONY_MULTIPLIER = 1,
	POP_MIN_SIZE_FOR_REGIMENT_NONCORE_MULTIPLIER = 1, -- VALUE * POP_MIN_SIZE_FOR_REGIMENT is min for noncores
	GAS_ATTACK_MODIFIER = 2,
	COMBATLOSS_WAR_EXHAUSTION = 5, -- base war exhaustion in combat
